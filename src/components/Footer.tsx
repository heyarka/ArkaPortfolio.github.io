  ...
  return (
    <footer className="py-10 px-6 md:px-10 bg-muted/30 border-t">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        <div>
          <h3 className="font-bold text-lg mb-4">Arka Das</h3>
          <p className="text-muted-foreground mb-4">
            Data analyst specializing in Excel solutions that drive business insights and decision-making.
          </p>
        ...
        <div>
          <h3 className="font-bold text-lg mb-4">Excel Services</h3>
          <ul className="space-y-2">
            <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Dashboard Development</a></li>
            <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Financial Modeling</a></li>
            <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Data Analysis</a></li>
            <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Process Automation</a></li>
            <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Custom Excel Solutions</a></li>
          </ul>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto mt-10 pt-6 border-t border-muted flex flex-col md:flex-row justify-between items-center">
        <p className="text-sm text-muted-foreground mb-4 md:mb-0">
          &copy; {new Date().getFullYear()} Arka Das. All rights reserved.
        </p>
